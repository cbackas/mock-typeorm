...
import { QueryBuilderReturnMethods, RepositoryMethods, SelfReferenceQueryBuilderMethods } from "./typeorm.types";
type MockHelper<T> = {
...
export type Methods = EntityManagerSetMockMethods | QueryBuilderReturnMethods | SelfReferenceQueryBuilderMethods | RepositoryMethods;
